...
public interface WorkPeopleDao {
     ...
     * @return 对象列表
     */
    List<WorkPeople> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<WorkPeople> queryAll(WorkPeople workPeople);
     ...
     * @return 影响行数
     */
    int insert(WorkPeople workPeople);
     ...
     * @return 影响行数
     */
    int update(WorkPeople workPeople);
